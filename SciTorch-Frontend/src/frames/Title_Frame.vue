  ...
  <div class="w-[70%] pl-8">
    <div class="h-20">
      ...
      <div class="w-full mt-3 mb-8" v-for="(article,index) in Articles" :key="index">
        <div class="text-blue-700 hover:text-blue-800 hover:underline" style="font-size: 20px; line-height: 24px;">{{article.title}}</div>
        <div class="mt-1.5 text-gray-800" style=" font-size: 13px; line-height: 16px;">{{article.author}}</div>
        <div class="flex">
          <div class="px-1 py-0.5 flex mt-2.5 hover:bg-white rounded-md transition-colors duration-400">
            <img src="../components/icons/Download_Icon.svg" alt="下载" class="h-4 mr-1.5 my-auto stroke-gray-600 hover:stroke-blue-700 transition-colors duration-400">
            <span class="my-auto text-xs text-gray-600 hover:text-blue-700 transition-colors duration-400">Download</span>
          </div>
          <div class="px-1 py-0.5 flex mt-2.5 hover:bg-white rounded-md transition-colors duration-400 ml-4">
            <img src="../components/icons/Like_Icon.svg" alt="收藏" class="h-4 mr-1.5 my-auto stroke-gray-600 hover:stroke-blue-700 transition-colors duration-400">
